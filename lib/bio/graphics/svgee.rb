module Bio
  class Graphics
    ...
    class SVGEE
      ...
      def polyline_tag(a={})
        if a[:link_val]
          %{<a href="#{a[:link_val]}"><polyline points="#{a[:points]}" fill="#{a[:fill]}" } + common_attributes(a) + %{ /></a>}
        else
      ...
      def polygon_tag(a={})
        if a[:link_val]
          %{<a href="#{a[:link_val]}"><polygon points="#{a[:points]}" fill="#{a[:fill_color]}" } + common_attributes(a) + %{ /></a>}
        else
      ...
      def text_tag(a = {})
        if a[:link_val]
          %{<a href="#{a[:link_val]}"><text x="#{a[:x]}" y="#{a[:y]}" fill="#{a[:fill]}" transform="#{a[:transform]}" style="#{a[:style]}">#{a[:text]}</text></a>}
        else
